...
End-to-end FRTB architecture with correct SBM aggregation, Vasicek DRC, and FHS-GARCH ES — but backtesting/PLAT data is mocked, risk class coverage is incomplete, and several calibrations are deliberately flat. Good as a learning reference or something to walk through in an interview; not something you'd submit to a regulator.
